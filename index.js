...
function getArtistByIndex(arr, i) {
  ...
  console.log(getArtistByIndex(artists, 16));
...
function get20s(arr, birth, death){  
  for (i=0; i<arr.length; i++){
    let life = arr[i].years.split(" - ", 2);
      if (life[0] >=birth && life[1] <= death){
...
console.log(addArtist(20, 'Tobias Steiner', '1972 - 0000', 'Web Design', 'Human Being', 'lorem ipseum'));
